...
export const projects = [
  {
    ...
    bullets: [
      ...
      'Atomic multi-dimensional enforcement across GLOBAL, USER, IP, and API_KEY — each dimension runs one Lua script (read → refill → decide → write) atomically; first denial short-circuits, remaining buckets uncharged.',
